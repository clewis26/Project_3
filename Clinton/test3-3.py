# -*- coding: utf-8 -*-
"""
Created on Thu Nov 03 15:36:31 2016
...
model.add(Convolution2D(32, 5, 5,init='he_normal', border_mode='same', input_shape=(1,60, 60)))
...
model.fit(data_in, data_out, nb_epoch=30, batch_size=50, verbose=1)

classes = model.predict_classes(data_in_tst, batch_size=50)

my_df = pd.DataFrame(classes)
my_df.columns=['Prediction']
my_df.to_csv(r'test_out2.csv', index_label="Id")
