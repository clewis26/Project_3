# -*- coding: utf-8 -*-
"""
Created on Wed Nov 02 00:40:38 2016
...
def load_data():
     ...
     test_set_x, test_set_y = shared_dataset(data_in_tst,y_valid)
     rval = [(train_set_x, train_set_y),(valid_set_x, valid_set_y),(test_set_x, test_set_y)]
     return rval


def stoch_grad_desc_train_model(
    gamma=0.13, epochs=1000, B=600
):
    """
    ...
    logreg = LogisticRegression(x=x, num_in=60**2, num_out=19)
